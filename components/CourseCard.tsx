...
const CourseCard: React.FC<CourseCardProps> = ({ course }) => {
  ...
  const instructorIds = [...new Set(course.groups.map(g => g.instructorId))];
  ...
  return (
    <a 
      ...
      onClick={(e) => handleNav(e, `#/course/${course.id}`)}
    ...
    >
      ...
      <div className="p-6">
        ...
        <p className="text-slate-600 leading-relaxed mb-4 text-sm h-10 overflow-hidden">{course.shortDescription}</p>
